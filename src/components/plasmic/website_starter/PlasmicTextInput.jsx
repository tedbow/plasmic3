...
import * as sty from "./PlasmicTextInput.module.css"; // plasmic-import: B9JER4avHDIJ/css
import SearchsvgIcon from "./icons/PlasmicIcon__Searchsvg"; // plasmic-import: WtiqdbePwRkC/icon
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 9CmaPbYuHPlP/icon
    ...
    >
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <SearchsvgIcon
              className={classNames(projectcss.all, sty.svg__zoP1D)}
              role={"img"}
            />
          ),
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <ChecksvgIcon
              className={classNames(projectcss.all, sty.svg__jTb6R)}
              role={"img"}
            />
          ),
